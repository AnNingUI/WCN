...
/*
 * Tiny embedded uncompressed 24-bit TGA smiley test image.
 * 8x8 pixels, BGR byte order per TGA spec.
 */
static const uint8_t k_sample_tga_2x2[] = {
    ,
...
int main(void) {
    ...
    if (!g_demo_image_ready) {
        fprintf(stderr, "Warning: embedded smiley TGA decode/upload failed\n");
    }
    ...
    while (!fs_glfw_backend_should_close(&backend)) {
        ...
        fs_style_reset(core);
        fs_path_begin(core);
        fs_style_set_image_smoothing_enabled(core, false);
